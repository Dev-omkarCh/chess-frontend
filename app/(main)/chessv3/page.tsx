        ...
        <TooltipProvider>
            ...
            <div className="flex flex-col h-screen bg-background text-foreground overflow-hidden">
                ...
                <header className="flex-shrink-0 h-14 border-b border-border bg-card flex items-center px-4 gap-3 z-50">
                    ...
                    <button className="absolute top-4 right-4 p-2 rounded-full hover:bg-muted transition-colors z-20" onClick={() => setIsSettingsOpen(true)}>
