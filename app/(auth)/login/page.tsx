        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="bg-card text-card-foreground border border-border p-8 rounded-3xl shadow-2xl space-y-6">
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <button className="w-full bg-primary text-primary-foreground py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 hover:brightness-110 active:scale-[0.98] transition-all shadow-lg shadow-primary/25">
                Sign In
                <ArrowRight size={18} />
              </button>
            </form>
            ...
            <button className="w-full flex items-center justify-center gap-3 bg-card hover:bg-card-hover border border-border py-3 rounded-xl font-semibold transition-all group">
